...
define("kang_xkwkj_RES", "../addons/" . kang_xkwkj . "/");
require_once IA_ROOT . "/addons/" . kang_xkwkj . "/dbutil.class.php";
require IA_ROOT . "/addons/" . kang_xkwkj . "/oauth2.class.php";
require_once IA_ROOT . "/addons/" . kang_xkwkj . "/value.class.php";
require_once IA_ROOT . "/addons/" . kang_xkwkj . "/monUtil.class.php";
require_once IA_ROOT . "/addons/" . kang_xkwkj . "/WxPayPubHelper/WxPayPubHelper.php";

/**
 * Class Mon_WkjModuleSite
 */
class kang_xkwkjModuleSite extends WeModuleSite
{
    public $weid;
    public $acid;
    public $oauth;
    ...
    public function doMobileShow()
    {
        ...
        $show_row = pdo_fetch('SELECT * FROM ' . tablename('kang_xkwkj_show') . " WHERE uniacid = '{$_W['uniacid']}'  AND openid = '{$openid}'");
        ...
        if (empty($show_row)) {
            ...
            pdo_insert('kang_xkwkj_show', $data);
        } else {
            ...
            pdo_update('kang_xkwkj_show', $data, array('openid' => $openid));
        }
        ...
        $show_list = pdo_fetch('SELECT * FROM ' . tablename('kang_xkwkj_show') . " WHERE uniacid = '{$_W['uniacid']}'  AND openid = '{$openid}'");
        $show_list['time'] = date('Y-m-d H:i:s', $show_list['createtime']);

        $sqlorder = 'SELECT * FROM ' . tablename('kang_xkwkj_order') . " WHERE `openid` = :openid";
    ...
    public function toPayTemplate($user, $orderInfo, $xkwkj)
    {
        ...
        $notifyUrl = $_W['siteroot'] . "addons/" . kang_xkwkj . "/notify.php";
    ...
    public function  doMobileAuth()
    {
        ...
        $params['au'] = $au;
        $params['uid'] = $uid;
        $userInfo = MonUtil::getClientCookieUserInfo(kang_xkwkjModuleSite::$USER_COOKIE_KEY . "" . $kid);
