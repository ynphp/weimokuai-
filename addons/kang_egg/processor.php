...
class Kang_eggModuleProcessor extends WeModuleProcessor {

    public function respond() {
        global $_W;
        $rid = $this->rule;
        $sql = "select title,description,start_picurl,isshow,starttime,endtime,end_theme,end_instruction,end_picurl from " . tablename('kang_egg_reply') . " where `rid`=:rid LIMIT 1";
