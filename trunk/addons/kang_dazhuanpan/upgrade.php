<?php
$sql = "
drop table  if exists `ims_kang_dazhuanpan_award`;
drop table  if exists `ims_kang_dazhuanpan_fans`;
drop table  if exists `ims_kang_dazhuanpan_data`;
drop table  if exists `ims_kang_dazhuanpan_reply`;
drop table  if exists `ims_kang_dazhuanpan_share`;
drop table  if exists `ims_kang_dazhuanpan_prize`;
";
$sqlnews = "
CREATE TABLE IF NOT EXISTS `ims_kang_dazhuanpan_reply` (
  ...
  `turntable` tinyint(1) DEFAULT '0' COMMENT '砸金蛋类型0普通1为九宫格',
  `turntablenum` tinyint(1) DEFAULT '6' COMMENT '奖品数量',
  `bigwheelpic` varchar(225) NOT NULL COMMENT '砸金蛋图',
...
CREATE TABLE IF NOT EXISTS `ims_kang_dazhuanpan_exchange` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `rid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '规则id',
  `uniacid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '公众号ID',
...
CREATE TABLE IF NOT EXISTS `ims_kang_dazhuanpan_template` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `uniacid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '公众号ID',
...
CREATE TABLE IF NOT EXISTS `ims_kang_dazhuanpan_tmplmsg` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `uniacid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '公众号ID',
...
CREATE TABLE IF NOT EXISTS `ims_kang_dazhuanpan_prize` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `rid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '规则id',
  `uniacid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '公众号ID',
...
CREATE TABLE IF NOT EXISTS `ims_kang_dazhuanpan_prizemika` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `rid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '规则id',
  `uniacid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '公众号ID',
...
CREATE TABLE IF NOT EXISTS `ims_kang_dazhuanpan_fans` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `rid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '规则id',
  `uniacid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '公众号ID',
  `from_user` varchar(50) NOT NULL DEFAULT '' COMMENT '用户openid',
...
CREATE TABLE IF NOT EXISTS `ims_kang_dazhuanpan_fansaward` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `rid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '规则id',
  `uniacid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '公众号ID',
...
CREATE TABLE IF NOT EXISTS `ims_kang_dazhuanpan_fanstmplmsg` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `rid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '规则id',
  `uniacid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '公众号ID',
  `from_user` varchar(50) DEFAULT '0' COMMENT '用户openid',
...
CREATE TABLE IF NOT EXISTS `ims_kang_dazhuanpan_sharedata` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `rid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '规则id',
  `uniacid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '公众号ID',
...
$sql_fanstmplmsg = "CREATE TABLE IF NOT EXISTS `ims_kang_dazhuanpan_fanstmplmsg` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `rid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '规则id',
  `uniacid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '公众号ID',
  `from_user` varchar(50) DEFAULT '0' COMMENT '用户openid',
...
if(!pdo_fieldexists('kang_dazhuanpan_reply', 'power')) {
	pdo_run($sql);
    pdo_run($sqlnews);
}
if(!pdo_fieldexists('kang_dazhuanpan_reply', 'tips')) {
	pdo_query("ALTER TABLE ".tablename('kang_dazhuanpan_reply')." ADD `tips` varchar(200) DEFAULT '' COMMENT '活动次数提示' AFTER `notprizetext`;");
}
if(!pdo_fieldexists('kang_dazhuanpan_reply', 'number_times_tips')) {
	pdo_query("ALTER TABLE ".tablename('kang_dazhuanpan_reply')." ADD `number_times_tips` varchar(100) DEFAULT '' COMMENT '超过总次数提示' AFTER `number_times`;");
}
if(!pdo_fieldexists('kang_dazhuanpan_reply', 'day_number_times_tips')) {
	pdo_query("ALTER TABLE ".tablename('kang_dazhuanpan_reply')." ADD `day_number_times_tips` varchar(100) DEFAULT '' COMMENT '超过每天次数提示' AFTER `day_number_times`;");
}
if(!pdo_fieldexists('kang_dazhuanpan_reply', 'award_num_tips')) {
	pdo_query("ALTER TABLE ".tablename('kang_dazhuanpan_reply')." ADD `award_num_tips` varchar(100) DEFAULT '' COMMENT '超过中奖数量提示' AFTER `award_num`;");
}
if(!pdo_fieldexists('kang_dazhuanpan_exchange', 'before')) {
	pdo_query("ALTER TABLE ".tablename('kang_dazhuanpan_exchange')." ADD `before` tinyint(1) unsigned NOT NULL DEFAULT '1' COMMENT '兑奖资料活动前还是中奖后1前2为后' AFTER `baidumaplat`;");
}else{
	pdo_run($sql_fanstmplmsg);
}
if(pdo_fieldexists('kang_dazhuanpan_share', 'sharenum')) {
	pdo_query("ALTER TABLE ".tablename('kang_dazhuanpan_share')." change `sharenum` `sharenum` varchar(5) DEFAULT '0' COMMENT '分享赠送礼盒基数';");
}
