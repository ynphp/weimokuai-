...
class weisrc_magpiebridgeModule extends WeModule {
    ...
    public function ruleDeleted($rid) {
        pdo_delete('weisrc_magpiebridge_reply', array('rid' => $rid));
        pdo_delete('weisrc_magpiebridge_fans', array('rid' => $rid));
        pdo_delete('weisrc_magpiebridge_record', array('rid' => $rid));
    }
