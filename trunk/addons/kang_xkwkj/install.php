 ...
 */
$sql = "
CREATE TABLE IF NOT EXISTS " . tablename('kang_xkwkj') . " (
...
$sql = "
CREATE TABLE IF NOT EXISTS " . tablename('kang_xkwkj_user') . " (
`id` int(10) unsigned  AUTO_INCREMENT,
`kid` int(10) NOT NULL,
 ...
 */
$sql = "
CREATE TABLE IF NOT EXISTS " . tablename('kang_xkwkj_firend') . " (
`id` int(10) unsigned  AUTO_INCREMENT,
`kid` int(10) NOT NULL,
`uid` int(10) NOT NULL,
 `openid` varchar(200) NOT NULL,
 ...
 */
$sql = "
CREATE TABLE IF NOT EXISTS " . tablename('kang_xkwkj_order') . " (
`id` int(10) unsigned  AUTO_INCREMENT,
`kid` int(10) NOT NULL,
`uid` int(10) NOT NULL,
`uname` varchar(100),
 ...
 */
$sql = "
CREATE TABLE IF NOT EXISTS " . tablename('kang_xkwkj_setting') . " (
`id` int(10) unsigned  AUTO_INCREMENT,
