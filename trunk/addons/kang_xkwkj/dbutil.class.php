...
class DBUtil
{
    ...
    public static $TABLE_XKWKJ = "kang_xkwkj";

    public static $TABLE_XKWKJ_USER = "kang_xkwkj_user";

    public static $TABLE_XKWKJ_FIREND = "kang_xkwkj_firend";

    public static $TABLE_XKWJK_ORDER = "kang_xkwkj_order";

    public static $TABLE_XKWKJ_SETTING = "kang_xkwkj_setting";
