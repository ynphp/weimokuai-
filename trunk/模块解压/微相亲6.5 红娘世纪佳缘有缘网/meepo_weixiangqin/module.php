	...
	public function ruleDeleted($rid = 0) {
	 ...
	 public function settingsDisplay($settings) {
		...
		if(!isset($settings['huodongtitle'])) {
			$settings['huodongtitle'] = '这里是meepo相亲平台';
		}
		if(!isset($settings['huodongurl'])) {
			$settings['huodongurl'] = 'http://demo.012wz.com';
		}
		if(!isset($settings['kefuphone'])) {
			$settings['kefuphone'] = '0755-61910103';
		}
		load()->func('tpl');
