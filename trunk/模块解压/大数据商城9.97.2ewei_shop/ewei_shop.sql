...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`wz479` /*!40100 DEFAULT CHARACTER SET utf8 */;
...
/*Data for the table `ims_ewei_shop_adv` */
...
/*Data for the table `ims_ewei_shop_article` */
...
/*Data for the table `ims_ewei_shop_article_category` */
...
/*Data for the table `ims_ewei_shop_article_log` */
...
/*Data for the table `ims_ewei_shop_article_report` */
...
/*Data for the table `ims_ewei_shop_article_share` */
...
/*Data for the table `ims_ewei_shop_article_sys` */
...
/*Data for the table `ims_ewei_shop_carrier` */
...
/*Data for the table `ims_ewei_shop_category` */
...
/*Data for the table `ims_ewei_shop_commission_apply` */
...
/*Data for the table `ims_ewei_shop_commission_clickcount` */
...
/*Data for the table `ims_ewei_shop_commission_level` */
...
/*Data for the table `ims_ewei_shop_commission_log` */
...
/*Data for the table `ims_ewei_shop_commission_shop` */
...
/*Data for the table `ims_ewei_shop_coupon` */
...
/*Data for the table `ims_ewei_shop_coupon_category` */
...
/*Data for the table `ims_ewei_shop_coupon_data` */
...
/*Data for the table `ims_ewei_shop_coupon_guess` */
...
/*Data for the table `ims_ewei_shop_coupon_log` */
...
/*Data for the table `ims_ewei_shop_creditshop_adv` */
...
/*Data for the table `ims_ewei_shop_creditshop_category` */
...
/*Data for the table `ims_ewei_shop_creditshop_goods` */
...
/*Data for the table `ims_ewei_shop_creditshop_log` */
...
/*Data for the table `ims_ewei_shop_designer` */
...
/*Data for the table `ims_ewei_shop_designer_menu` */
...
/*Data for the table `ims_ewei_shop_dispatch` */
...
/*Data for the table `ims_ewei_shop_diyform_category` */
...
/*Data for the table `ims_ewei_shop_diyform_data` */
...
/*Data for the table `ims_ewei_shop_diyform_temp` */
...
/*Data for the table `ims_ewei_shop_diyform_type` */
...
/*Data for the table `ims_ewei_shop_exhelper_express` */
...
/*Data for the table `ims_ewei_shop_exhelper_senduser` */
...
/*Data for the table `ims_ewei_shop_exhelper_sys` */
...
/*Data for the table `ims_ewei_shop_express` */
...
/*Data for the table `ims_ewei_shop_feedback` */
...
/*Data for the table `ims_ewei_shop_goods` */
...
/*Data for the table `ims_ewei_shop_goods_comment` */
...
/*Data for the table `ims_ewei_shop_goods_option` */
...
/*Data for the table `ims_ewei_shop_goods_param` */
...
/*Data for the table `ims_ewei_shop_goods_spec` */
...
/*Data for the table `ims_ewei_shop_goods_spec_item` */
...
/*Data for the table `ims_ewei_shop_member` */
...
/*Data for the table `ims_ewei_shop_member_address` */
...
/*Data for the table `ims_ewei_shop_member_cart` */
...
/*Data for the table `ims_ewei_shop_member_favorite` */
...
/*Data for the table `ims_ewei_shop_member_group` */
...
/*Data for the table `ims_ewei_shop_member_history` */
...
/*Data for the table `ims_ewei_shop_member_level` */
...
/*Data for the table `ims_ewei_shop_member_log` */
...
/*Data for the table `ims_ewei_shop_member_message_template` */
...
/*Data for the table `ims_ewei_shop_notice` */
...
CREATE TABLE `ims_ewei_shop_order` (
  ...
  `notify_flag` char(1) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `idx_uniacid` (`uniacid`),
  KEY `idx_openid` (`openid`),
  KEY `idx_shareid` (`agentid`),
...
/*Data for the table `ims_ewei_shop_order` */
...
/*Data for the table `ims_ewei_shop_order_comment` */
...
/*Data for the table `ims_ewei_shop_order_goods` */
...
/*Data for the table `ims_ewei_shop_order_refund` */
...
/*Data for the table `ims_ewei_shop_perm_log` */
...
/*Data for the table `ims_ewei_shop_perm_plugin` */
...
/*Data for the table `ims_ewei_shop_perm_role` */
...
/*Data for the table `ims_ewei_shop_perm_user` */
...
/*Data for the table `ims_ewei_shop_plugin` */

LOCK TABLES `ims_ewei_shop_plugin` WRITE;

insert  into `ims_ewei_shop_plugin`(`id`,`displayorder`,`identity`,`name`,`version`,`author`,`status`,`category`) values (1,1,'qiniu','七牛存储','1.0','官方',1,'tool'),(2,2,'taobao','淘宝助手','1.0','官方',1,'tool'),(3,3,'commission','人人分销','1.0','官方',1,'biz'),(4,4,'poster','超级海报','1.2','官方',1,'sale'),(5,5,'verify','O2O核销','1.0','官方',1,'biz'),(6,6,'tmessage','会员群发','1.0','官方',1,'tool'),(7,7,'perm','分权系统','1.0','官方',0,'help'),(8,8,'sale','营销宝','1.0','官方',1,'sale'),(9,10,'creditshop','积分商城','1.0','官方',1,'biz'),(10,11,'virtual','虚拟物品','1.0','官方',1,'biz'),(11,9,'designer','店铺装修','1.0','官方',1,'help'),(12,13,'coupon','超级券','1.0','官方',1,'sale'),(13,14,'postera','活动海报','1.0','官方',1,'sale'),(14,11,'article','文章营销','1.0','官方',1,'help'),(15,15,'diyform','自定义表单','1.0','官方',1,'help'),(16,16,'system','系统工具','1.0','官方',0,'help'),(17,16,'exhelper','快递助手','1.0','官方',0,'help');
...
/*Data for the table `ims_ewei_shop_poster` */
...
/*Data for the table `ims_ewei_shop_poster_log` */
...
/*Data for the table `ims_ewei_shop_poster_qr` */
...
/*Data for the table `ims_ewei_shop_poster_scan` */
...
/*Data for the table `ims_ewei_shop_postera` */
...
/*Data for the table `ims_ewei_shop_postera_log` */
...
/*Data for the table `ims_ewei_shop_postera_qr` */
...
/*Data for the table `ims_ewei_shop_refund_address` */
...
/*Data for the table `ims_ewei_shop_saler` */
...
/*Data for the table `ims_ewei_shop_store` */
...
/*Data for the table `ims_ewei_shop_sysset` */
...
/*Data for the table `ims_ewei_shop_system_copyright` */
...
/*Data for the table `ims_ewei_shop_virtual_category` */
...
/*Data for the table `ims_ewei_shop_virtual_data` */
...
/*Data for the table `ims_ewei_shop_virtual_type` */
