...
function widget_search($title){ ?>
	...
	<input type="submit" class="searchan" value="搜索文章" />
	</form>
	</ul>
	</div>
<?php } ?>
...
function neighbor_log($neighborLog){
	extract($neighborLog);?>
	<?php if($prevLog):?>
	<div class="prev-article"><a href="<?php echo Url::log($prevLog['gid']) ?>"><img src="<?php echo TEMPLATE_URL; ?>images/toolbar_previous.gif" /><?php echo $prevLog['title'];?></a></div>
	<?php endif;?>
	<?php if($nextLog && $prevLog):?>
		
	<?php endif;?>
	<?php if($nextLog):?>
		 <div class="next-article"><a href="<?php echo Url::log($nextLog['gid']) ?>"><img src="<?php echo TEMPLATE_URL; ?>images/toolbar_next.gif" /><?php echo $nextLog['title'];?></a></div>
	<?php endif;?>
<?php }?>
<?php
//blog：引用通告
...
$randval   =   rand(0,9); 
            ...
            $thum_url = BLOG_URL.'content/templates/fense/images/rand/'.$randval.'.jpg';
        }
    }
echo $thum_url;
}
...
function get_rand_log(){
	...
	$randLogs = $Log_Model->getRandLog($index_randlognum);?>
	<?php foreach($randLogs as $value): ?>
	<div class="picwall_frame">
<a href="<?php echo Url::log($value['gid']); ?>" title="<?php echo $value['title']; ?>" class="picwall_img"><img width="180" height="220" src="<?php get_thum($value['gid']); ?>" alt="<?php echo $value['title']; ?>"></a>
<p class="picwall_article"><a href="<?php echo Url::log($value['gid']); ?>" target="_blank" title="点击阅读文章 [<?php echo $value['title']; ?>]">阅读文章</a></p>
<p class="picwall_goods"><a href="#" rel="nofollow" target="_blank" title="点击直接购买 [<?php echo $value['title']; ?>]">直接购买</a></p></div>
	<?php endforeach; ?>
<?php }?>
