<?php
  if(!empty($cfg['mchid'])){
	...
	try {
		...
		pdo_insert('tiger_jifenbao_paylog',array("uniacid"=>$_W["uniacid"],"dwnick"=>$member['nickname'],"dopenid"=>$_W['fans']['from_user'],"dtime"=>time(),"dcredit"=>$kjfabc,"dtotal_amount"=>$kjfabc1,"dmch_billno"=>$mch_billno,"dissuccess"=>$dissuccess,"dresult"=>$dresult));        
