<?php
	...
	$goods = pdo_fetchall("SELECT id, title FROM " . tablename('hc_moreshop_goods')." WHERE hid = ".$host['id']." and weid = ".$_W['uniacid']);
	$good = array();
	foreach($goods as $g){
		$good[$g['id']] = $g['title'];
	}
