...
define('CLOUD_URL', "http://addons.176dj.com");
...
function _cloud_build_params() {
	...
	$pars['username'] = $_W['setting']['site']['username'];
...
function cloud_download($path, $type = '') {
	...
	$dat = ihttp_request(CLOUD_URL, $pars, $headers, 300);
	if(is_error($dat)) {
