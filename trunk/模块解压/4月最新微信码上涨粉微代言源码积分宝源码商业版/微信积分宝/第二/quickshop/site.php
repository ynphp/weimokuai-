...
class QuickShopModuleSite extends WeModuleSite{
    ...
    public function doMobileList(){
        ...
        $rpsize = 6;
        list($rlist, $rtotal) = $_goods -> batchGetByRecommend($_W['weid'], $vip_cond, $rpindex, $rpsize);
        $shareby_str = empty($_W['fans']['from_user']) ? '' : '&shareby=' . $_W['fans']['from_user'];
        $share = array();
        $share['title'] = $title;
        $share['content'] = $title;
    ...
    public function setOrderCredit($orderid, $add = true){
        ...
        if (Order :: $PAY_ONLINE == $order['paytype']){
    ...
    public function doMobilePay(){
        ...
        foreach ($allgoods as $row){
            if ($row['support_delivery'] == 0){
                ...
                $_W['account']['payment']['delivery']['switch'] = false;
            }
