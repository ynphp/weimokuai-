	...
	$.fn.kinMaxShow = function(user_options){
			...
			var default_options = {
						...
						button:{
								...
								//当前 按钮样式
								focus:{background:"#ff6600",border:"1px solid #fff",color:"#000000"}
							},
			...
			var cssCode = '<style type="text/css">';
				...
				if(options.button.normal.display!='none'){
					...
					cssCode+= k.selector+' .'+k.prename+'button li{'+k.fn.objToCss(options.button.normal,['top','right','bottom','left'])+';cursor:pointer;-webkit-text-size-adjust:none;border-radius:15px}';				
...
$(document).ready(function(){$("#kinMaxShow").kinMaxShow({height:400,easing: 'swing',intervalTime: 5,button: {normal: {right: '45%'}}});});