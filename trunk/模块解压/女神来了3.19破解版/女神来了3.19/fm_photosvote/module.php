...
class Fm_photosvoteModule extends WeModule
{
	...
	public function fieldsFormDisplay($rid = 0)
	{
		...
		if (!empty($rid)) {
			$basic = pdo_fetch("SELECT * FROM " . tablename($this->table_reply) . " WHERE rid = :rid ORDER BY `id` DESC", array(':rid' => $rid));
			$share = pdo_fetch("SELECT * FROM " . tablename($this->table_reply_share) . " WHERE rid = :rid ORDER BY `id` DESC", array(':rid' => $rid));
			$huihua = pdo_fetch("SELECT * FROM " . tablename($this->table_reply_huihua) . " WHERE rid = :rid ORDER BY `id` DESC", array(':rid' => $rid));
			...
			$body = pdo_fetch("SELECT * FROM " . tablename($this->table_reply_body) . " WHERE rid = :rid ORDER BY `id` DESC", array(':rid' => $rid));
		...
		$reply['votetime'] = empty($reply['votetime']) ? "10" : $reply['votetime'];
		$qiniu['videologo'] = empty($qiniu['videologo']) ? "http://n.fmoons.com/web/resource/images/gw-logo.png" : $qiniu['videologo'];
		...
		//if ($reply['t']['s'] == 0) {
			...
			//} else {
			//	message('当前网速较慢或者授权有问题,请等待，或者咨询请联系你的服务提供商...');
			//}
		//}
	...
	public function fieldsFormSubmit($rid)
	{
		...
		$insert_basic = array('rid' => $rid, 'uniacid' => $uniacid, 'status' => $status, 'title' => $_GPC['title'], 'picture' => $_GPC['picture'], 'start_time' => strtotime($_GPC['datelimit']['start']), 'end_time' => strtotime($_GPC['datelimit']['end']), 'tstart_time' => strtotime($_GPC['tdatelimit']['start']), 'tend_time' => strtotime($_GPC['tdatelimit']['end']), 'bstart_time' => strtotime($_GPC['bdatelimit']['start']), 'bend_time' => strtotime($_GPC['bdatelimit']['end']), 'ttipstart' => $_GPC['ttipstart'], 'ttipend' => $_GPC['ttipend'], 'btipstart' => $_GPC['btipstart'], 'btipend' => $_GPC['btipend'], 'isdaojishi' => intval($_GPC['isdaojishi']), 'ttipvote' => $_GPC['ttipvote'], 'votetime' => $_GPC['votetime'], 'description' => $_GPC['description'], 'content' => htmlspecialchars_decode($_GPC['content']), 'stopping' => $_GPC['stopping'], 'nostart' => $_GPC['nostart'], 'end' => $_GPC['end']);
		$insert_share = array('rid' => $rid, 'subscribe' => intval($_GPC['subscribe']), 'shareurl' => $_GPC['shareurl'], 'sharetitle' => $_GPC['sharetitle'], 'sharephoto' => $_GPC['sharephoto'], 'sharecontent' => $_GPC['sharecontent'], 'subscribedes' => $_GPC['subscribedes']);
		$insert_huihua = array('rid' => $rid, 'command' => $_GPC['command'], 'tcommand' => $_GPC['tcommand'], 'ishuodong' => $_GPC['ishuodong'], 'huodongname' => $_GPC['huodongname'], 'huodongdes' => $_GPC['huodongdes'], 'hhhdpicture' => $_GPC['hhhdpicture'], 'huodongurl' => $_GPC['huodongurl'], 'regmessagetemplate' => $_GPC['regmessagetemplate'], 'messagetemplate' => $_GPC['messagetemplate'], 'shmessagetemplate' => $_GPC['shmessagetemplate'], 'fmqftemplate' => $_GPC['fmqftemplate'], 'msgtemplate' => $_GPC['msgtemplate']);
		$insert_display = array('rid' => $rid, 'istopheader' => intval($_GPC['istopheader']), 'ipannounce' => intval($_GPC['ipannounce']), 'isbgaudio' => intval($_GPC['isbgaudio']), 'isvoteusers' => intval($_GPC['isvoteusers']), 'bgmusic' => $_GPC['bgmusic'], 'isedes' => intval($_GPC['isedes']), 'tmoshi' => intval($_GPC['tmoshi']), 'indextpxz' => intval($_GPC['indextpxz']), 'indexorder' => $_GPC['indexorder'], 'indexpx' => intval($_GPC['indexpx']), 'phbtpxz' => intval($_GPC['phbtpxz']), 'zanzhums' => $_GPC['zanzhums'], 'xuninum' => $_GPC['xuninum'], 'hits' => $_GPC['hits'], 'xuninumtime' => $_GPC['xuninumtime'], 'xuninuminitial' => $_GPC['xuninuminitial'], 'xuninumending' => $_GPC['xuninumending'], 'isrealname' => intval($_GPC['isrealname']), 'ismobile' => intval($_GPC['ismobile']), 'isweixin' => intval($_GPC['isweixin']), 'isqqhao' => intval($_GPC['isqqhao']), 'isemail' => intval($_GPC['isemail']), 'isjob' => intval($_GPC['isjob']), 'isxingqu' => intval($_GPC['isxingqu']), 'isaddress' => intval($_GPC['isaddress']), 'isindex' => intval($_GPC['isindex']), 'isvotexq' => intval($_GPC['isvotexq']), 'ispaihang' => intval($_GPC['ispaihang']), 'isreg' => intval($_GPC['isreg']), 'isdes' => intval($_GPC['isdes']), 'lapiao' => $_GPC['lapiao'], 'sharename' => $_GPC['sharename'], 'tpname' => $_GPC['tpname'], 'tpsname' => $_GPC['tpsname'], 'rqname' => $_GPC['rqname'], 'csrs' => $_GPC['csrs'], 'ljtp' => $_GPC['ljtp'], 'cyrs' => $_GPC['cyrs'], 'iscopyright' => intval($_GPC['iscopyright']), 'copyright' => $_GPC['copyright'], 'copyrighturl' => $_GPC['copyrighturl']);
		$regtitlearr = array('cmmrealname' => $_GPC['cmmrealname'], 'cmmmobile' => $_GPC['cmmmobile'], 'cmmweixin' => $_GPC['cmmweixin'], 'cmmqqhao' => $_GPC['cmmqqhao'], 'cmmemail' => $_GPC['cmmemail'], 'cmmjob' => $_GPC['cmmjob'], 'cmmxingqu' => $_GPC['cmmxingqu'], 'cmmaddress' => $_GPC['cmmaddress']);
		$insert_display['regtitlearr'] = iserializer($regtitlearr);
		$insert_vote = array('rid' => $rid, 'iscode' => intval($_GPC['iscode']), 'codekey' => $_GPC['codekey'], 'addpvapp' => intval($_GPC['addpvapp']), 'isfans' => intval($_GPC['isfans']), 'mediatype' => intval($_GPC['mediatype']), 'mediatypem' => intval($_GPC['mediatypem']), 'mediatypev' => intval($_GPC['mediatypev']), 'voicemoshi' => $_GPC['voicemoshi'], 'moshi' => intval($_GPC['moshi']), 'webinfo' => htmlspecialchars_decode($_GPC['webinfo']), 'cqtp' => intval($_GPC['cqtp']), 'tpsh' => intval($_GPC['tpsh']), 'isbbsreply' => intval($_GPC['isbbsreply']), 'tmyushe' => $_GPC['tmyushe'], 'tmreply' => $_GPC['tmreply'], 'isipv' => intval($_GPC['isipv']), 'ipturl' => $_GPC['ipturl'], 'ipstopvote' => intval($_GPC['ipstopvote']), 'iplocallimit' => $_GPC['iplocallimit'], 'iplocaldes' => $_GPC['iplocaldes'], 'tpxz' => $_GPC['tpxz'] > 8 ? '8' : intval($_GPC['tpxz']), 'autolitpic' => intval($_GPC['autolitpic']), 'autozl' => $_GPC['autozl'] > 100 ? '100' : intval($_GPC['autozl']), 'limitip' => $_GPC['limitip'], 'daytpxz' => intval($_GPC['daytpxz']), 'dayonetp' => intval($_GPC['dayonetp']), 'allonetp' => intval($_GPC['allonetp']), 'fansmostvote' => intval($_GPC['fansmostvote']), 'userinfo' => $_GPC['userinfo'], 'votesuccess' => $_GPC['votesuccess'], 'limitsd' => intval($_GPC['limitsd']), 'limitsdps' => intval($_GPC['limitsdps']));
		$insert_body = array('rid' => $rid, 'zbgcolor' => $_GPC['zbgcolor'], 'zbg' => $_GPC['zbg'], 'voicebg' => $_GPC['voicebg'], 'zbgtj' => $_GPC['zbgtj'], 'topbgcolor' => $_GPC['topbgcolor'], 'topbg' => $_GPC['topbg'], 'topbgtext' => $_GPC['topbgtext'], 'topbgrightcolor' => $_GPC['topbgrightcolor'], 'topbgright' => $_GPC['topbgright'], 'foobg1' => $_GPC['foobg1'], 'foobg2' => $_GPC['foobg2'], 'foobgtextn' => $_GPC['foobgtextn'], 'foobgtexty' => $_GPC['foobgtexty'], 'foobgtextmore' => $_GPC['foobgtextmore'], 'foobgmorecolor' => $_GPC['foobgmorecolor'], 'foobgmore' => $_GPC['foobgmore'], 'bodytextcolor' => $_GPC['bodytextcolor'], 'bodynumcolor' => $_GPC['bodynumcolor'], 'inputcolor' => $_GPC['inputcolor'], 'bodytscolor' => $_GPC['bodytscolor'], 'bodytsbg' => $_GPC['bodytsbg'], 'xinbg' => $_GPC['xinbg'], 'copyrightcolor' => $_GPC['copyrightcolor']);
		if (($_W['role'] == 'founder')) {
	...
	public function ruleDeleted($rid)
	{
		...
		pdo_delete($this->table_provevote_name, array('rid' => $rid));
		pdo_delete($this->table_provevote_voice, array('rid' => $rid));
	}
