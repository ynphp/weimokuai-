...
if (!Array.prototype.indexOf) {
    ...
    b.showPage = function(c) {
        var d = b('<div class="frame-dialog"><div class="phbphb" id="phbphb"><img src="../addons/meepo_paoma/template/mobile/images/phbphb.png" class="phbtop" ><div class="phbk"><div class="phbbiaok"><iframe frameborder="0" src="' + c + '"></iframe></div></div></div><div class="closebutton"></div></div>');
    ...
    b(function() {
        ...
        function() {
            ...
            b.getJSON(PATH_ACTIVITY + "?ac=wxc_password&callback=", {
                scene_id: scene_id,
