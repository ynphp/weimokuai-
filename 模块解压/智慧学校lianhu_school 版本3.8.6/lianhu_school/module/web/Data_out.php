...
if($ac=='sroce'){
	...
	if($_GPC['excel']){
		...
		$objPHPExcel->getProperties()->setCreator("智慧学校")->setLastModifiedBy("智慧学校")->setTitle("Office 2007 XLSX Test Document")->setSubject("Office 2007 XLSX Test Document")->setDescription("Test document for Office 2007 XLSX, generated using PHP classes.")->setKeywords("office 2007 openxml php")->setCategory("report file");
