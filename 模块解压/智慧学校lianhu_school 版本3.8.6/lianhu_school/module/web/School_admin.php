<?php 
    ...
    load()->model('user');
    $power="cookbook|leave|home_work|lianhu_school_menu_teacher|lianhu_school_menu_course|lianhu_school_menu_student|lianhu_school_menu_msg|lianhu_school_menu_syllabus|lianhu_school_menu_neimsg|lianhu_school_menu_line|lianhu_school_menu_data_in|lianhu_school_menu_data_out|lianhu_school_menu_appointment|lianhu_school_menu_test|lianhu_school_menu_score_list|lianhu_school_menu_money|lianhu_school_menu_grade|lianhu_school_menu_class|lianhu_school_menu_student_record|lianhu_school_menu_video";
