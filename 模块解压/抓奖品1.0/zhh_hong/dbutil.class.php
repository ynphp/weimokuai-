 ...
 */
  ...
  class CRUD{
      ...
      public static   $table_zjp ="zhh_hong";

    public static   $table_zjp_prize ="zhh_hong_prize";

    public static   $table_zjp_user ="zhh_hong_user";

      public static   $table_zjp_record ="zhh_hong_record";
