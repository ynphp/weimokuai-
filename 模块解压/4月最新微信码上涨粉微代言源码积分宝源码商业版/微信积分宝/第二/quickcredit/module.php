...
class QuickCreditModule extends WeModule{
    public function settingsDisplay($settings){
        ...
        if (checksubmit('installmenu')){
            ...
            ({$_W['weid']}, 'group09', 'commission-credit-settled', 'commission', 1, '已结算利润(积分部分)', '', '{$_W['siteroot']}/addons/quickcredit/images/icon.png', 'quickcredit', 'Center', 'getExchangedCredit', 0, 1)");
                if (!empty($ret)){
