...
var lc = window.location;
	var request_url = lc.href.split('#')[0];
	var wxurl = INDEX_URL;
	var wximg = SHARE_IMG;
	...
	share_timeline_data = {
		...
		callbackfunc: function() {
           // track('【点击右上角分享成功】','BTN');
			...
			if (window._tag)  _tag.dcsMultiTrack ('wt.event', 'click', 'wt.msg', '点击右上角分享成功');
		}
...
//http://e.pizzahut.com.cn/student/lovedecipher/index.html?shareid=36
