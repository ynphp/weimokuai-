...
(function (e, t) {
    ...
    var n, r, i = e.document, s = e.location, o = e.navigator, u = e.jQuery, a = e.$, f = Array.prototype.push, l = Array.prototype.slice, c = Array.prototype.indexOf, h = Object.prototype.toString, p = Object.prototype.hasOwnProperty, d = String.prototype.trim, v = function (e, t) {
        ...
        i.addEventListener ? (i.removeEventListener("DOMContentLoaded", A, !1), v.ready()) : i.readystatus === "complete" && (i.detachEvent("onreadystatuschange", A), v.ready())
    }, O = {};
    v.fn = v.prototype = {
        constructor: v,
        init: function (e, n, r) {
        ...
        if (!r) {
            r = v.Deferred();
            if (i.readystatus === "complete")
                setTimeout(v.ready, 1);
            else if (i.addEventListener) 
                i.addEventListener("DOMContentLoaded", A, !1), e.addEventListener("load", v.ready, !1);
            else {
                i.attachEvent("onreadystatuschange", A), e.attachEvent("onload", v.ready);
                var n = !1;
                try {
    ...
    v.fn.extend({
        ...
        v.cssHooks[t] = {
            get: function (e, n, r) {
                if (n) 
                    return e.offsetWidth === 0 && It.test(Dt(e, "display")) ? v.s(e, Xt, function () {
                        return tn(e, t, r) 
                    }) : tn(e, t, r) 
            },
            set: function (e, n, r) {
    ...
    ln = wn.exec(cn.toLowerCase()) || [], v.fn.load = function (e, n, r) {
        ...
        ajax: function (e, n) {
            function T(e, n, s, a) {
                ...
                if (E === 2) 
                    return;
                E = 2, u && clearTimeout(u), o = t, i = a || "", x.readystatus = e > 0 ? 4 : 0, s && (w = An(c, x, s));
                if (e >= 200 && e < 300 || e === 304) 
                    c.ifModified && (S = x.getResponseHeader("Last-Modified"), S && (v.lastModified[r] = S), S = x.getResponseHeader("Etag"), S && (v.etag[r] = S)), e === 304 ? (T = "notmodified", l = !0) : (l = On(c, w), T = l.status, y = l.data, b = l.error, l = !b);
                else {
                    b = T;
                    if (!T || e) 
                        T = "error", e < 0 && (e = 0) 
            ...
            if (!c.beforeSend || c.beforeSend.call(h, x, c) !== !1 && E !== 2) {
                ...
                if (!o) 
                    ...
                    x.readystatus = 1, f && p.trigger("ajaxSend", [x, c]), c.async && c.timeout > 0 && (u = setTimeout(function () {
                        x.abort("timeout") 
                    }, c.timeout));
                    try {
                        E = 1, o.send(b, T) 
    ...
    v.ajaxSetup({
        ...
        if (e.crossDomain) {
            ...
            return {
                send: function (s, o) {
                    n = i.createElement("script"), n.async = "async", e.scriptCharset && (n.charset = e.scriptCharset), n.src = e.url, n.onload = n.onreadystatuschange = function (e, i) {
                        if (i || !n.readystatus || /loaded|complete/.test(n.readystatus))
                            n.onload = n.onreadystatuschange = null, r && n.parentNode && r.removeChild(n), n = t, i || o(200, "success")
            ...
            return {
                send: function (i, s) {
                    ...
                    a.send(n.hasContent && n.data || null), r = function (e, i) {
                        var u, f, l, c, h;
                        try {
                            if (r && (i || a.readystatus === 4)) {
                                r = t, o && (a.onreadystatuschange = v.noop, Bn && delete Hn[o]);
                                if (i) 
                                    a.readystatus !== 4 && a.abort();
                                else {
                        ...
                        c && s(u, f, c, l) 
                    }, n.async ? a.readystatus === 4 ? setTimeout(r, 0) : (o = ++jn, Bn && (Hn || (Hn = {}, v(e).unload(Bn)), Hn[o] = r), a.onreadystatuschange = r) : r()
                },
                abort: function () {
                    r && r(0, 1) 
                }
