...
/*
		var	d1 = '<img src="../addons/hc_weibb/images/1.png" />';
		var	 d2 = '<img src="../addons/hc_weibb/images/2.png" />';
		var	 d3 = '<img src="../addons/hc_weibb/images/3.png" />';
		var	 d4 = '<img src="../addons/hc_weibb/images/4.png" />';
		var	 d5 = '<img src="../addons/hc_weibb/images/5.png" />';
		var	 d6 = '<img src="../addons/hc_weibb/images/6.png" />';
*/
    ...
    var popupbobing = (function () {
        ...
        popupbobing.prototype = {
            ...
            show: function () {
                ...
                var self = this;
				var bg =  '<div id="' + this.id + '" class="afpopupbobing hidden" style="background-image: url(../addons/hc_weibb/images/pupopbg.png);background-size:100%">';
				var last =    '<header>' + this.title + '</header>' +
                         ...
                         '</div></div>';
                var markup = bg+last;
					$("#promptnopopup").css("background-image","url(../addons/hc_weibb/images/pupupopbg.png)");
...
bobing.moveStart = function () {
    ...
    var pic = function (time) {
       time = parseInt(time) + 100;
		...
		pic1.style.backgroundImage = "url(../addons/hc_weibb/images/g1.png)";
        pic2.style.backgroundImage = "url(../addons/hc_weibb/images/g1.png)";
        pic3.style.backgroundImage = "url(../addons/hc_weibb/images/g1.png)";
        pic4.style.backgroundImage = "url(../addons/hc_weibb/images/g1.png)";
        pic5.style.backgroundImage = "url(../addons/hc_weibb/images/g1.png)";
        pic6.style.backgroundImage = "url(../addons/hc_weibb/images/g1.png)";
...
bobing.moveEnd = function () {
    ...
    for (var i = 0; i < 6; i++) {
        var id = "pic" + (1 + i);
        document.getElementById(id).style.backgroundImage = "url(../addons/hc_weibb/images/d" + this.num[i] + ".png)";
		
	
    }
	/*
	str1=  "<img src='../addons/hc_weibb/images/" + this.num[0] + ".png' >";
	str2=  "<img src='../addons/hc_weibb/images/" + this.num[2] + ".png' >";
	str3=  "<img src='../addons/hc_weibb/images/" + this.num[3] + ".png' >";
	str4=  "<img src='../addons/hc_weibb/images/" + this.num[4] + ".png' >";
	str5=  "<img src='../addons/hc_weibb/images/" + this.num[5] + ".png' >";
	str6=  "<img src='../addons/hc_weibb/images/" + this.num[1] + ".png' >";
...
console.log(this);
		if(this.huode == '一秀'){
					 $("#resultpopup").css("background-image","url(../addons/hc_weibb/images/yixiu.png)");
		}if(this.huode == '二举'){
					 $("#resultpopup").css("background-image","url(../addons/hc_weibb/images/erju.png)");
		}if(this.huode == '三红'){
					 $("#resultpopup").css("background-image","url(../addons/hc_weibb/images/sanhong.png)");
		}if(this.huode == '四进'){
					 $("#resultpopup").css("background-image","url(../addons/hc_weibb/images/sijing.png)");
		}if(this.huode == '对堂'){
					 $("#resultpopup").css("background-image","url(../addons/hc_weibb/images/duitang.png)");
		}if(this.huode == '普通状元'){
					 $("#resultpopup").css("background-image","url(../addons/hc_weibb/images/putongzhuangyuan.png) ");
		}if(this.huode == '五子'){
					 $("#resultpopup").css("background-image","url(../addons/hc_weibb/images/wuzi.png)");
		}if(this.huode == '五红'){
					 $("#resultpopup").css("background-image","url(../addons/hc_weibb/images/wuhong.png)");
		}if(this.huode == '六杯红'){
					 $("#resultpopup").css("background-image","url(../addons/hc_weibb/images/liupu.png)");
		}if(this.huode == '状元插金花'){
					 $("#resultpopup").css("background-image","url(../addons/hc_weibb/images/chajinghua.png)");
		}
		if(this.huode == '未中奖'){
					 $("#resultpopup").css("background-image","url(../addons/hc_weibb/images/weizhongjiang.png)");
		}else{
            ...
            if (this.status == 0) {
                ...
                window.setTimeout(function () {
                  ...
                  //          message: '登录超时'
						...
						$("#promptoutpopup").css("background-image","url(../addons/hc_weibb/images/wangluoyichang.png)");
                   ...
                   //     $("#promptoutpopup").bind("click", function () { $("#promptoutpopup").trigger("close"); });
                    ...
                    //        message: '网络出问题啦!'
						...
						$("#promptwwwpopup").css("background-image","url(../addons/hc_weibb/images/wangluoyichang.png);");
